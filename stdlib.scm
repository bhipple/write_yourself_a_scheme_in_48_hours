...
; Defining a list, which just returns a list of arguments
(define (list . objs) objs)

; Identity function, to be used by higher order functions
(define (id obj) obj)
...
; Convenience, to match historical Scheme names
(define fold foldl)
(define reduce foldr)
